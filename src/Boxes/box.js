...
const BoxSvg = (props) => {
    ...
    return(
    <BoxStyle>
    <svg x="0px" y="0px"  width="40%" height="20%" viewBox="0 0 100 100" enable-background="new 0 0 100 100">
    <defs>
    <linearGradient id="leftWall" gradientTransform="rotate(5)">
      <stop offset="10%"  stop-color="#b9865c" />
      <stop offset="100%" stop-color="#8d5631" />
    </linearGradient>
    <linearGradient id="backWall" gradientTransform="rotate(45)">
      <stop offset="5%"  stop-color="#53301b" />
      <stop offset="100%" stop-color="#8d5631" />
    </linearGradient>
    <linearGradient id="backFlap" gradientTransform="rotate(180)">
      <stop offset="1%"  stop-color="#8d5631" />
      <stop offset="100%" stop-color="#53301b" />
    </linearGradient>
    <linearGradient id="leftFlap" gradientTransform="rotate(35)">
      <stop offset="5%"  stop-color="#954d2c" />
      <stop offset="100%" stop-color="#b9865c" />
    </linearGradient>
    <linearGradient id="dropShadow_1" gradientTransform="rotate(15)" >
	<stop  offset="10%" stop-color="#808080" />
	<stop  offset="100%" stop-opacity='0' stop-color="#c89869"/>
    </linearGradient>
    <linearGradient id="frontWall" gradientTransform="rotate(5)">
      <stop offset="5%"  stop-color="#c89869" />
      <stop offset="100%" stop-color="#9b7751" />
    </linearGradient>
    <linearGradient id="rightWall" gradientTransform="rotate(15)">
      <stop offset="10%"  stop-color="#814b29" />
      <stop offset="100%" stop-color="#c89869" />
    </linearGradient>
    <linearGradient id="rightFlap" gradientTransform="rotate(10)">
      <stop offset="25%"  stop-color="#954d2c" />
      <stop offset="100%" stop-color="#a07834" />
    </linearGradient>
  </defs>
    ...
    <polygon id="leftWall" fill="url('#leftWall')"   stroke-width="0.144" stroke-linejoin="round" points="34.719,66.26 
    ...
    <polygon id="backFlap" fill="url('#backFlap')"    points="89.627,23.117 
